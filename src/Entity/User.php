...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\ManyToOne]
    private ?RatingScale $ratingScale = null;

    /**
     * @var Collection<int, UserGame>
     */
    #[ORM\OneToMany(targetEntity: UserGame::class, mappedBy: 'userId')]
    ...
    public function getRatingScale(): ?RatingScale
    {
        return $this->ratingScale;
    }

    public function setRatingScale(?RatingScale $ratingScale): static
    {
